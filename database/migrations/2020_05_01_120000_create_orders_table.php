...
class CreateOrdersTable extends Migration
{
    public function up()
    {
        Schema::create('orders', function (Blueprint $table) {
            ...
            $table->foreignIdFor(app('location')); // Due to accounting constraints, orders must be at a location and cannot have bookings for multiple locations.
            ...
            $table->unsignedInteger('partial_redemption_voucher_id')->nullable();
